...
Тогда для обеспечения хранения данных на серверах с 4096 Gbs SSD и 40Tbs HDD нам потребуется  ~ 600 серверов с запасом. С учетом расчета 464 сервера из пункта с Базами Данных берем 600 серверов данной комплектации, обеспечивая > 25% запаса производительности. 
